...
<br /> 게임 모드 FSM 아키텍처 및 이벤트 그래프 커스텀 액션 노드를 설계했고, Localization을 책임지고 수행하는 등 게임 플레이 전반의 흐름을 안정시키는 시스템 설계를 수행했습니다.
<br /> 기획자와 속도감 있는 협업이 가능한 데이터 기반 구조를 구축하는 것이 제 강점입니다.
